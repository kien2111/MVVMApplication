...
public class ExpandTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public ExpandTextView(Context context, AttributeSet attrs) {
        ...
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(R.styleable.ExpandTextView_trimCollapsedText, R.string.read_more);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(R.styleable.ExpandTextView_trimExpandedText, R.string.read_less);
        ...
        this.trimLines = typedArray.getInt(R.styleable.ExpandTextView_trimLines, DEFAULT_TRIM_LINES);
        this.colorClickableText = typedArray.getColor(R.styleable.ExpandTextView_colorClickableText,
                ContextCompat.getColor(context, R.color.colorAccent));
        this.showTrimExpandedText =
                typedArray.getBoolean(R.styleable.ExpandTextView_showTrimExpandedText, DEFAULT_SHOW_TRIM_EXPANDED_TEXT);
        this.trimMode = typedArray.getInt(R.styleable.ExpandTextView_trimMode, TRIM_MODE_LINES);
        typedArray.recycle();
