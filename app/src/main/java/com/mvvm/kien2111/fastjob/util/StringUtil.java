...
public final class StringUtil {
    ...
    public static String formatPoint(double param){
        DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols();
        decimalFormatSymbols.setDecimalSeparator('.');
        decimalFormatSymbols.setGroupingSeparator(',');
    ...
    public static String[] getQuotes(Context context){
        ...
        String[] proverts = context.getResources().getStringArray(R.array.proverb);
        String[] authors = context.getResources().getStringArray(R.array.author);
        int rannum = random.nextInt(proverts.length);
        return new String[]{proverts[rannum],authors[rannum]};
    }
