...
import static com.mvvm.kien2111.mvvmapplication.model.Status.*;
...
public class Resource<T> {
    ...
    public static <T> Resource<T> error(String msg,@NonNull int repsonseCode) {
        return new Resource<>(ERROR, msg,repsonseCode);
    }
